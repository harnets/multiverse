    :
      ...
      cmdBeginRenderingKHR( reinterpret_cast<PFN_vkCmdBeginRenderingKHR>(checkPtr(get_dev_addr(ctx, "vkCmdBeginRenderingKHR"), "vkCmdBeginRenderingKHR"))),
      cmdEndRenderingKHR( reinterpret_cast<PFN_vkCmdEndRenderingKHR>(checkPtr(get_dev_addr(ctx, "vkCmdEndRenderingKHR"), "vkCmdEndRenderingKHR"))),
      cmdWriteTimestamp( reinterpret_cast<PFN_vkCmdWriteTimestamp>(checkPtr(get_dev_addr(ctx, "vkCmdWriteTimestamp"), "vkCmdWriteTimestamp")))
